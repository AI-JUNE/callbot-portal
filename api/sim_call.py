...
SCRIPTS = {
    # --- 이음 3세대 상생(메인) · 전용 프롬프트 경로(툴 미사용) ---
    "welfare":  ["여보세요, 기초연금 신청하고 싶어요", "주민센터 안 가고 전화로 되나요?",
                 "홍길동이고 1954년 3월생이에요", "네 신청해 주세요", "네 감사합니다"],
    "trio":     ["여보세요, 봉사 참여하고 싶어요", "청년이고 주말에 어르신 돌봄 하고 싶어요",
                 "광산구 수완동이요", "안전은 어떻게 확인하나요?", "네 신청할게요"],
    ...
    # 이음 2R 안부 시나리오(기분·식사·수면·통증 4문항) — 전화망 미경유
    "wellbeing": ["여보세요", "그냥 그렇지 뭐, 좀 심심해요", "입맛이 없어서 한 끼만 먹었어요",
                  "밤에 자주 깨요", "무릎이 좀 쑤셔요", "네 고마워요"],
